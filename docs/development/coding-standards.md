...
| Requirement | Detail |
| --- | --- |
| **Coverage floor** | **90%** statement coverage on `./internal/...` (`task coverage`, `COVERAGE_MIN`) |
| **Next target** | Hold 90% floor until measured coverage sustains ≥90.5%; next ratchet TBD (COV-90-00) |
